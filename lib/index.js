...
function initCastServer(ctx, cfg, bridge, ffmpegManager) {
	...
	const register = ((opts) => {
		...
		const guarded = async (req, res) => {
			if (!sameOriginOk(req)) return sendJson(res, 403, {
				ok: false,
...
if (!G.taskSpaces) G.taskSpaces = {
  ...
  complete: function(id, opts){ return need('completeTaskSpace')(id, opts) },
}
...
if (!G.page) {
  G.page = {
    ...
    screenshot: function(o){ return need('captureScreenshot')(o || {}) },
